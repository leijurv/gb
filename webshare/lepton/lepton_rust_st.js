/* @ts-self-types="./lepton_rust_st.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function decode_lepton(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_lepton(ptr0, len0);
    if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
export function encode_lepton(jpeg_data) {
    const ptr0 = passArray8ToWasm0(jpeg_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encode_lepton(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lepton_rust_st_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
