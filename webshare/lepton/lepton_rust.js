 ...
 * @returns {Uint8Array}
 */
export function decode_lepton(data, num_threads) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_lepton(ptr0, len0, num_threads);
    if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
export function encode_lepton(jpeg_data, num_threads) {
    const ptr0 = passArray8ToWasm0(jpeg_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encode_lepton(ptr0, len0, num_threads);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
